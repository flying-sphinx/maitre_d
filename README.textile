...
mount MaitreD::CloudControl::API => '/cloudcontrol'</code></pre>

h3. Without Rails

This library provides two APIs as mountable Rack applications for you - so you'll want to mount them at the appropriate paths: @MaitreD::Heroku::API@ at @/heroku@ and/or @MaitreD::CloudControl::API@ at @/cloudcontrol@.
